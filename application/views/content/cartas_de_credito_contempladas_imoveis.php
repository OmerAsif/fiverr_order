<div class="container full">
    <div class="container">
        <div class="row pt50 pb70">        
            <div class="col-lg-12">
                <h1 class="txtCenter mb15 tituloConteudo">Cartas de Crédito Contempladas de Imóveis</h1>
                <p class="mb30 txtCenter lh26 e18 me16"><strong class="fn">Consórcio Contemplado de Imóveis</strong> de diversas administradoras. Temos <strong class="fn">Consórcios Contemplados Imóveis Bradesco</strong>, <strong class="fn">Cota Contemplada Itaú Imóvel</strong>, <strong class="fn">Carta de Crédito Contemplada de Imóveis Porto Seguro</strong> e tantas outras. Escolha a sua <strong class="fn">cota contemplada de imóvel</strong> e aguarde o nosso contato.</p>
            ...
            <div class="col-lg-12">
                <a href="venda-de-consorcio.html"><img src="<?php echo base_url() ?>img/modelo/vender-consorcio-contemplado-ou-nao.jpg" width="100%" border="0" class="mb50 img-rounded" /></a>
            </div>        </div>
    </div>
</div>
